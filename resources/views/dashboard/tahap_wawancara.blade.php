...
<div class="tombol mx-5">
    ...
    <div class="col-12 col-md-4 me-3 d-inline">
        <a href="/tahap_wawancara?id={{ $data_user->Organisasi_id }}" class="btn btn-primary">Tahap Wawancara</a>
    </div>
    <div class="col-12 col-md-4 d-inline">
        <a href="/tahap_administrasi?id={{ $data_user->Organisasi_id }}" class="btn btn-outline-warning">Tahap Administrasi</a>
    </div>
</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="/notifikasi" method="POST">
            ...
            <input type="hidden" name="tahap" value="wawancara">
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    var btnTerima = document.getElementById('btn-tolak');
